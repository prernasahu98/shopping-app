...
export class ProductsService {
  ...
  products = [
    ...
    {
      "image": 'assets/loose-fit.jpg',
      "availableSizes": ["X", "L", "XL", "XXL"],
      "currencyFormat": "$",
      "currencyId": "USD",
      "description": "Treino 2014",
      "id": 15, "installments": 5,
      "isFreeShipping": true,
      "price": 14,
    ...
    {
      "image": 'assets/white-stripes.jpg',
      "availableSizes": ["X", "L"],
      "currencyFormat": "$",
      "currencyId": "USD",
    ...
    {
      "image": 'assets/blue-sweatshirt.jpeg',
      "availableSizes": ["S"],
      "currencyFormat": "$",
      "currencyId": "USD",
  ...
  getItem(index: number) {
    this.currentItem = this.products[index];
  }
